...
export class UserService {
  ...
  addBaby(body: Baby): Promise<User> {
    const url = this.baseUrl +`/users/user/babies/add`;
  ...
  getBabyAge(babyName: string): Promise<BabyAge> {
    const url = this.baseUrl +`/users/user/babies/baby/` + babyName + `/age`;
  ...
  getAllBabyMeasurements(babyName: string, measurementType: any): Promise<any> {
    const url = this.baseUrl +`/users/user/babies/baby/${babyName}/measurements/${measurementType}`;
    return this.http.get(url, this.getOptions())
      .toPromise()
  ...
  getBabyMeasurementsFromDayToDay(babyName: string, measurementType: any, from: number, to: number): Promise<any> {
    const url = this.baseUrl +`/users/user/babies/baby/${babyName}/measurements/${measurementType}/periodInDays`;
  ...
  getBabyMeasurementsFromDateToDate(babyName: string, measurementType: string, from: string, to: string): Promise<any> {
    const url = this.baseUrl + `/users/user/babies/baby/${babyName}/measurements/${measurementType}/periodInDates`;
    const params: URLSearchParams = new URLSearchParams();
  ...
  getAllBabyMeasurementsChart(babyName: string, measurementType: any): Promise<any> {
    const url = this.baseUrl + `/users/user/babies/baby/${babyName}/measurements/${measurementType}/chart`;
    return this.http.get(url, this.getOptions())
      .toPromise()
      .then(response => response.json() as any)
      .catch(this.handleError);
  ...
  getBabyMeasurementsFromDayToDayChart(babyName: string, measurementType: any, from: number, to: number): Promise<any> {
    const url = this.baseUrl + `/users/user/babies/baby/${babyName}/measurements/${measurementType}/periodInDays/chart`;
    const params: URLSearchParams = new URLSearchParams();
    params.set('from', String(from));
    params.set('to', String(to));
    const options = new RequestOptions({params: params});
  ...
  getBabyMeasurementsFromDateToDateChart(babyName: string, measurementType: string, from: string, to: string): Promise<any> {
    const url = this.baseUrl + `/users/user/babies/baby/${babyName}/measurements/${measurementType}/periodInDates/chart`;
    const params: URLSearchParams = new URLSearchParams();
    params.set('from', from);
    params.set('to', to);
    const options = new RequestOptions({params: params});
  ...
  compareBabies(babies, measurementType: string) {
    const url = this.baseUrl +`/users/user/babies/compare`;
    const params: URLSearchParams = new URLSearchParams();
